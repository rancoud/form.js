describe("form_helper - setFieldLoading", function(){
    beforeEach(function() {
        document.body.innerHTML = ``;
        require("../src/form");
    });

    it("should return error 'Invalid argument elemID' for setFieldLoading", function(done) {
        const formHelper = new window.FormHelper();
        let err;

        err = formHelper.setFieldLoading(1);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get number");

        err = formHelper.setFieldLoading(true);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get boolean");

        err = formHelper.setFieldLoading(false);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get boolean");

        err = formHelper.setFieldLoading([]);
        expect(err).toBeInstanceOf(TypeError);
        ...
        err = formHelper.setFieldLoading(NaN);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get number");

        err = formHelper.setFieldLoading(undefined);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get undefined");

        err = formHelper.setFieldLoading(null);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get object");
    ...
    it("should return error 'DOM element not found' for setFieldLoading", function(done) {
        const formHelper = new window.FormHelper();
        let err;
    ...
    it("should work for setFieldLoading -> 0 container + 0 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    <label class="form__label form__label--error" for="form-login-input-user" id="form-login-label-user-error">Username is required</label>
        ...
        err = formHelper.setFieldLoading("form-login-input-user");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<div class="form__element">
    <label class="form__label" for="form-login-input-user" id="form-login-label-user">Username</label>
    <input aria-invalid="true" aria-labelledby="form-login-label-user" aria-required="true" autocomplete="username" class="form__input" data-form-error-required="Username is required" data-form-rules="required" id="form-login-input-user" name="form-login-input-user" type="text">
...
<div class="form__element">
    ...
    it("should work for setFieldLoading -> 1 container + 0 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    <div class="form__container">
        <input aria-invalid="true" aria-labelledby="form-login-label-user" aria-required="true" autocomplete="username" class="form__input" data-form-error-required="Username is required" data-form-has-container="" data-form-rules="required" id="form-login-input-user" name="form-login-input-user" type="text">
    </div>
...
<div class="form__element">
    ...
    it("should work for setFieldLoading -> 0 container + 1 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    <label class="form__label" for="form-login-input-user" id="form-login-label-user">Username</label>
    <input aria-invalid="true" aria-labelledby="form-login-label-user" aria-required="true" autocomplete="username" class="form__input" data-form-error-required="Username is required" data-form-rules="required" id="form-login-input-user" name="form-login-input-user" type="text">
    <span class="form__feedback form__feedback--loading"></span>
</div>`);
...
<div class="form__element">
    ...
    it("should work for setFieldLoading -> 1 container + 1 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    it("should work for setFieldLoading -> 1 container + 2 feedbacks + 1 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldLoading -> 1 input checkbox (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset form__fieldset--error">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldLoading("form-login-input-cgu");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
    ...
    <div class="form__element">
        <div class="form__container form__container--invisible">
            <input aria-invalid="true" aria-labelledby="form-login-label-cgu" class="form__input form__input--checkbox" data-form-error-checked="CGU is required" data-form-has-container="" data-form-rules="checked" id="form-login-input-cgu" name="form-login-input-cgu" type="checkbox" value="remember">
            <label class="form__label form__label--checkbox" for="form-login-input-cgu" id="form-login-label-cgu">
                <span aria-hidden="true" class="form__fake-checkbox">
                    <svg class="form__fake-checkbox-svg" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <path class="form__fake-checkbox-path" d="M461.6,109.6l-54.9-43.3c-1.7-1.4-3.8-2.4-6.2-2.4c-2.4,0-4.6,1-6.3,2.5L194.5,323c0,0-78.5-75.5-80.7-77.7  c-2.2-2.2-5.1-5.9-9.5-5.9c-4.4,0-6.4,3.1-8.7,5.4c-1.7,1.8-29.7,31.2-43.5,45.8c-0.8,0.9-1.3,1.4-2,2.1c-1.2,1.7-2,3.6-2,5.7  c0,2.2,0.8,4,2,5.7l2.8,2.6c0,0,139.3,133.8,141.6,136.1c2.3,2.3,5.1,5.2,9.2,5.2c4,0,7.3-4.3,9.2-6.2L462,121.8  c1.2-1.7,2-3.6,2-5.8C464,113.5,463,111.4,461.6,109.6z"></path>
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldLoading -> 1 input file (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset form__fieldset--error">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldLoading("form-login-input-file");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldLoading -> 2 inputs radio (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldLoading("form-login-input-twitch-yes");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
    ...
    <div class="form__element">
        <fieldset class="form__fieldset">
            ...
            <input aria-invalid="true" class="form__input form__input--radio" data-form-error-checked="Twitch is required" data-form-rules="checked" id="form-login-input-twitch-yes" name="form-login-input-twitch" type="radio" value="yes">
            <label class="form__label form__label--radio" for="form-login-input-twitch-yes" id="form-login-label-twitch-yes">
                <span aria-hidden="true" class="form__fake-radio">
                    <svg class="form__fake-radio-svg" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <circle class="form__fake-radio-path" cx="50%" cy="50%" r="40%"></circle>
        ...
        err = formHelper.setFieldLoading("form-login-input-twitch-no");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
    ...
    <div class="form__element">
        <fieldset class="form__fieldset">
            ...
            <div class="form__container form__container--invisible">
                <input aria-invalid="true" class="form__input form__input--radio" data-form-error-checked="Twitch is required" data-form-has-container="" data-form-rules="checked" id="form-login-input-twitch-no" name="form-login-input-twitch" type="radio" value="no">
                <label class="form__label form__label--radio" for="form-login-input-twitch-no" id="form-login-label-twitch-no">
                    <span aria-hidden="true" class="form__fake-radio">
                        <svg class="form__fake-radio-svg" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            <circle class="form__fake-radio-path" cx="50%" cy="50%" r="40%"></circle>
    ...
    it("should work for setFieldLoading -> fieldset recursion stopped after 10 tries", function(done) {
        const formHelper = new window.FormHelper();
        let err;
