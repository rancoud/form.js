describe("form_helper - setFieldNeutral", function(){
    ...
    it("should return error 'Invalid argument elemID' for setFieldNeutral", function(done) {
        const formHelper = new window.FormHelper();
        let err;

        err = formHelper.setFieldNeutral(1);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get number");

        err = formHelper.setFieldNeutral(true);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get boolean");

        err = formHelper.setFieldNeutral(false);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get boolean");

        err = formHelper.setFieldNeutral([]);
        expect(err).toBeInstanceOf(TypeError);
        ...
        err = formHelper.setFieldNeutral(NaN);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get number");

        err = formHelper.setFieldNeutral(undefined);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get undefined");

        err = formHelper.setFieldNeutral(null);
        expect(err).toBeInstanceOf(TypeError);
        expect(err.message).toBe("Invalid argument elemID, expect string, get object");
    ...
    it("should return error 'DOM element not found' for setFieldNeutral", function(done) {
        const formHelper = new window.FormHelper();
        let err;

        err = formHelper.setFieldNeutral("azerty");
    ...
    it("should work for setFieldNeutral -> 0 container + 0 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    <label class="form__label form__label--error" for="form-login-input-user" id="form-login-label-user-error">Username is required</label>
        ...
        err = formHelper.setFieldNeutral("form-login-input-user");
...
<div class="form__element">
    ...
    it("should work for setFieldNeutral -> 1 container + 0 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    it("should work for setFieldNeutral -> 0 container + 1 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    it("should work for setFieldNeutral -> 1 container + 1 feedback + 0 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<div class="form__element">
    ...
    it("should work for setFieldNeutral -> 1 container + 2 feedbacks + 1 fieldset (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldNeutral -> 1 input checkbox (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset form__fieldset--error">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldNeutral("form-login-input-cgu");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldNeutral -> 1 input file (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset form__fieldset--error">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldNeutral("form-login-input-file");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
...
<fieldset class="form__fieldset">
    ...
    it("should work for setFieldNeutral -> 2 inputs radio (call twice for assuring it's okay)", function(done) {
        const formHelper = new window.FormHelper();
        let err;
...
<fieldset class="form__fieldset">
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldNeutral("form-login-input-twitch-yes");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
    ...
    <div class="form__element">
        ...
        err = formHelper.setFieldNeutral("form-login-input-twitch-no");
        expect(err).toBeUndefined();
        expect(document.body.innerHTML).toBe(`
<fieldset class="form__fieldset">
    <legend>My Form</legend>
    ...
    it("should work for setFieldNeutral -> fieldset recursion stopped after 10 tries", function(done) {
        const formHelper = new window.FormHelper();
        let err;
